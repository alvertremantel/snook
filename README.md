...
store, with board/project/activity/group organization, task editing and
sorting, archive and soft-delete lifecycles, task dependencies and tags,
attributed timers, pause/resume/stop lifecycle, durable interval history,
...
The default run also includes expanded task, history, and calendar editors
(`tasks-details`, `history-details`, `calendar-details`) and the bottom of
Today and Settings (`today-bottom`, `settings-bottom`), for 15 images total.
